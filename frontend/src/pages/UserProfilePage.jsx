...
import { MapPin, Briefcase, Mail, Phone, MessageCircle } from "lucide-react";
            ...
            {isLoading ? (
              ...
              <div className="p-6">
                  ...
                  <div className="text-center sm:text-left flex-1">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mt-4">
                      <div className="bg-blue-50 rounded-lg p-2 text-center">
                        <div className="text-xl font-bold text-blue-600">{user.sessionsTaught || 0}</div>
                        <div className="text-sm text-gray-600">Sessions</div>
                      </div>
                      <div className="bg-green-50 rounded-lg p-2 text-center">
                        <div className="text-xl font-bold text-green-600">{user.points || 0}</div>
                        <div className="text-sm text-gray-600">Points</div>
                      </div>
                      <div className="bg-purple-50 rounded-lg p-2 text-center">
                        <div className="text-xl font-bold text-purple-600">{user.rating || 0}</div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                  {user.email && (
                    <a href={`mailto:${user.email}`} className="flex items-center gap-2 bg-gray-50 rounded-xl p-4 hover:bg-gray-100">
                      <Mail className="text-gray-500" />
                      <span className="text-gray-700">{user.email}</span>
                    </a>
                  )}
                  {user.phone && (
                    <a href={`tel:${user.phone}`} className="flex items-center gap-2 bg-gray-50 rounded-xl p-4 hover:bg-gray-100">
                ...
                <div className="mt-6 flex justify-center">
                  <button
                    ...
                    className="flex items-center gap-2 px-6 py-3 bg-blue-500 text-white rounded-xl hover:bg-blue-600 transition-colors duration-300"
                  >
